...
extern struct theme_data_t {
    ...
    short int menu_app_wallpaper_transparency;  // 0-255
    ...
    short int menu_app_grid_menu_unselected_font_size;
    ...
    short int menu_app_grid_menu_selected_font_size;
    lv_color_t menu_app_grid_menu_selected_bg_color;
    char menu_app_grid_menu_selected_bg_source[128];
    short int menu_app_grid_menu_selected_transparency;  // 0-255
    
    // menu app grid menu icon 
    short int menu_app_grid_menu_icon_width;
    short int menu_app_grid_menu_icon_height;
